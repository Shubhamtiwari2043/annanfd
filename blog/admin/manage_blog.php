...
<section class="home-section">
  ...
  <table class="manage_table">
    ...
    include 'config.php';
    $i = 1;
    $sql = "SELECT * FROM `blog` order by upload desc";
    ...
    if ($row > 0) {
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        <tbody>
          ...
          <td class="content_left" style="padding:7px"><?php echo $row['content'] ?></td>
          <td>
            <a class="btn btn-primary" href="edit_blog.php?id=<?php echo $row['id'] ?>">Edit</a>
            <button class="btn btn-danger delete_blog" data-id="<?php echo $row['id']; ?>"><i
